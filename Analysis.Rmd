...
<center>*Also, if you already have R installed, consider downloading this project from GitHub [here](https://github.com/nathankchan/shopify-ds-intern-challenge) to run your own custom analysis!*

*Open a terminal, navigate to the repo, and type in `Rscript app.R` for an interactive GUI that produces histogram-density plots and key metrics.*</center>
