...
a. Consider metrics beyond AOV (i.e., the *arithmetic mean*), such as the *median*, *mode*, *geometric mean*, and *harmonic mean*.
b. The most appropriate metric to report is the <span style = "color:green">***geometric mean***</span>.
c. The value of the *geometric mean* is `$285.02`.
...
The most appropriate metric to report is the <span style = "color:green">***geometric mean***</span>. Its value is `$285.02`.
...
<center>Speedy Express shipped **54** orders in total.</center>
...
<center>The last name of the employee with the most orders is **Peacock**.</center>
...
<center>The product most ordered by customers in Germany was **Boston Crab Meat**.</center>
